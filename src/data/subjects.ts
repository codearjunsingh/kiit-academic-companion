...
export const SCHEME_A_SEM2_COURSES: Subject[] = [
  ...
  {
    code: 'MA11011',
    name: 'Linear Algebra, Numerical Methods & Fourier Analysis',
    scheme: 'Scheme A',
    semester: 2,
    category: 'BS',
    type: 'Theory',
    ...
    textbook: 'Advanced Engineering Mathematics by Erwin Kreyszig (10th Ed) & Numerical Methods by Jain, Iyengar & Jain',
    referenceBook: 'Higher Engineering Mathematics by B.S. Grewal',
    youtubeSearchQuery: 'Linear Algebra and Fourier Analysis MA11011',
    chapters: [
      { id: 'ma2_ch1', title: 'Unit-I: Vector Spaces & Systems of Linear Equations (Ch 7.1, 7.3, 7.4, 7.8, 7.9, 20.3)', module: 'Unit I', difficulty: 'Medium' },
      { id: 'ma2_ch2', title: 'Unit-II: Eigenvalues & Eigenvectors of Matrices (Ch 8.1, 8.3-8.5)', module: 'Unit II', difficulty: 'Hard' },
      { id: 'ma2_ch3', title: 'Unit-III: Numerical Methods & Root Finding (Ch 2.1-2.3)', module: 'Unit III', difficulty: 'Medium' },
      { id: 'ma2_ch4', title: 'Unit-IV: Interpolation & Approximation (Ch 4.2, 4.3 & Ch 19.3)', module: 'Unit IV', difficulty: 'Medium' },
      { id: 'ma2_ch5', title: 'Unit-V: Numerical Differentiation & Integration (Ch 5.2, 5.6)', module: 'Unit V', difficulty: 'Medium' },
      { id: 'ma2_ch6', title: 'Unit-VI: Numerical Solution to ODE (Ch 6.3)', module: 'Unit VI', difficulty: 'Hard' },
      { id: 'ma2_ch7', title: 'Unit-VII: Fourier Series & Fourier Transform (Ch 11.1, 11.2, 11.7-11.9)', module: 'Unit VII', difficulty: 'Hard' },
    ]
  },
  {
    code: 'CH10009',
  ...
  {
    code: 'CH19001',
    name: 'Chemistry Laboratory (Practical)',
    scheme: 'Scheme A',
    semester: 2,
    category: 'BS',
    type: 'Practical',
    ...
    textbook: 'KIIT School of Applied Sciences Chemistry Practical Lab Manual',
    youtubeSearchQuery: 'Engineering Chemistry Practical Lab Experiments',
    chapters: [
      { id: 'chlab_expt1', title: 'Expt 1: Determination of Hardness of Water Sample (EDTA Method)', module: 'Lab Experiments', difficulty: 'Easy' },
      { id: 'chlab_expt2', title: 'Expt 2: Determination of Alkalinity of Water Sample', module: 'Lab Experiments', difficulty: 'Easy' },
      { id: 'chlab_expt3a', title: 'Expt 3(a): Standardisation of KMnO4 Solution', module: 'Lab Experiments', difficulty: 'Easy' },
      { id: 'chlab_expt3b', title: 'Expt 3(b): Estimation of Fe2+ ions in Mohr Salt', module: 'Lab Experiments', difficulty: 'Medium' },
      { id: 'chlab_expt4', title: 'Expt 4: Determination of Dissolved Oxygen (DO) in Water', module: 'Lab Experiments', difficulty: 'Medium' },
      { id: 'chlab_expt5', title: 'Expt 5: Potentiometric Titration of Strong Acid vs Strong Base', module: 'Lab Experiments', difficulty: 'Medium' },
      { id: 'chlab_expt6', title: 'Expt 6: Kinetics of Ester Hydrolysis (Rate Constant Determination)', module: 'Lab Experiments', difficulty: 'Hard' },
      { id: 'chlab_expt7', title: 'Expt 7: Chloride Estimation in Water Sample (Mohr Method)', module: 'Lab Experiments', difficulty: 'Medium' },
      { id: 'chlab_expt8', title: 'Expt 8: pH Metric Titration of Acid vs Base', module: 'Lab Experiments', difficulty: 'Easy' },
      { id: 'chlab_expt9', title: 'Expt 9: Conductometric Titration of Strong/Weak Acid Mixture', module: 'Lab Experiments', difficulty: 'Medium' },
      { id: 'chlab_expt10', title: 'Expt 10: Verification of Beer-Lambert Law using Spectrophotometer', module: 'Lab Experiments', difficulty: 'Medium' },
      { id: 'chlab_expt11', title: 'Expt 11: Band Gap Calculation of ZnO Nanoparticles', module: 'Lab Experiments', difficulty: 'Hard' },
      { id: 'chlab_expt12', title: 'Expt 12: Determination of Isoelectric Point (pI) of Glycine', module: 'Lab Experiments', difficulty: 'Hard' },
      { id: 'chlab_expt13', title: 'Expt 13: Preparation & Characterization of Bis-(N,N\'-Disalicylidene Ethylenediamine)', module: 'Lab Experiments', difficulty: 'Hard' },
      { id: 'chlab_expt14', title: 'Expt 14: Size Determination of Silver Nanoparticles by UV-Vis', module: 'Lab Experiments', difficulty: 'Hard' },
      { id: 'chlab_expt15', title: 'Expt 15: Spectrometric Determination of Phosphate by Molybdenum Blue Method', module: 'Lab Experiments', difficulty: 'Hard' },
    ]
  },
  {
    code: 'EC19001',
